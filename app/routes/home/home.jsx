  ...
  return (
    <div className={styles.home}>
      ...
      <ProjectSummary
        ...
        description="**Tulip** is a decentralized finance (DeFi) application built on Solana, empowering users to lend, borrow, and earn interest on their cryptocurrency assets with ease and transparency."
        buttonText="View website"
        buttonLink="https://tulip.garden/"
        model={{
          type: 'phone',
